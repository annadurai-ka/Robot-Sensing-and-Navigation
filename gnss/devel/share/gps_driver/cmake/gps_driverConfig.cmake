...
if("TRUE" STREQUAL "TRUE")
  set(gps_driver_SOURCE_PREFIX /home/kaviak/EECE5554/gnss/src/gps_driver)
  set(gps_driver_DEVEL_PREFIX /home/kaviak/EECE5554/gnss/devel)
  ...
  set(gps_driver_INSTALL_PREFIX /home/kaviak/EECE5554/gnss/install)
...
if(NOT "/home/kaviak/EECE5554/gnss/devel/include " STREQUAL " ")
  set(gps_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/kaviak/EECE5554/gnss/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gps_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kaviak/EECE5554/gnss/src/gps_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kaviak/EECE5554/gnss/devel/lib;/home/kaviak/catkin_ws/devel/lib;/opt/ros/noetic/lib)

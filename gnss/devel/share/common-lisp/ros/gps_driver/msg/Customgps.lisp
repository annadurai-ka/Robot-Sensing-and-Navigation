...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Customgps>)))
  ...
  (cl:format cl:nil "# Customgps.msg~%Header header~%float64 latitude~%float64 longitude~%float64 altitude~%float64 utm_easting~%float64 utm_northing~%uint8 zone~%string letter~%float64 hdop~%string gpgga_read~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Customgps)))
  "Returns full string definition for message of type 'Customgps"
  (cl:format cl:nil "# Customgps.msg~%Header header~%float64 latitude~%float64 longitude~%float64 altitude~%float64 utm_easting~%float64 utm_northing~%uint8 zone~%string letter~%float64 hdop~%string gpgga_read~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
